...
export declare namespace PrevalidatePayload {
    function getJsonObj(obj: PrevalidatePayload): object;
    function getDeserializedJsonObj(obj: PrevalidatePayload): object;
}
