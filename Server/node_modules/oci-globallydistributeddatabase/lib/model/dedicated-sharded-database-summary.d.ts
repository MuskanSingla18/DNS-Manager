...
export declare namespace DedicatedShardedDatabaseSummary {
    enum DbWorkload {
        Oltp = "OLTP",
        Dw = "DW",
        /**
    ...
    function getJsonObj(obj: DedicatedShardedDatabaseSummary, isParentJsonObj?: boolean): object;
    const dbDeploymentType = "DEDICATED";
    function getDeserializedJsonObj(obj: DedicatedShardedDatabaseSummary, isParentJsonObj?: boolean): object;
}
