...
export declare namespace PatchShardedDatabaseDetails {
    function getJsonObj(obj: PatchShardedDatabaseDetails): object;
    function getDeserializedJsonObj(obj: PatchShardedDatabaseDetails): object;
}
