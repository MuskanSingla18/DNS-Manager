...
export declare namespace ChangeShardedDatabaseCompartmentDetails {
    function getJsonObj(obj: ChangeShardedDatabaseCompartmentDetails): object;
    function getDeserializedJsonObj(obj: ChangeShardedDatabaseCompartmentDetails): object;
}
