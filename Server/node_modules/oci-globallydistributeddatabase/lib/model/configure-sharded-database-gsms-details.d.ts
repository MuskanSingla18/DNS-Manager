...
export declare namespace ConfigureShardedDatabaseGsmsDetails {
    function getJsonObj(obj: ConfigureShardedDatabaseGsmsDetails): object;
    function getDeserializedJsonObj(obj: ConfigureShardedDatabaseGsmsDetails): object;
}
