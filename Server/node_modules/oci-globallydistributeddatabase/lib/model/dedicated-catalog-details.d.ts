...
export declare namespace DedicatedCatalogDetails {
    enum Status {
        Failed = "FAILED",
        Deleting = "DELETING",
        Deleted = "DELETED",
    ...
    function getJsonObj(obj: DedicatedCatalogDetails): object;
    function getDeserializedJsonObj(obj: DedicatedCatalogDetails): object;
}
