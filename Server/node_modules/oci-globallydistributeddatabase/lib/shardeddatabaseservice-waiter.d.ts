...
export declare class ShardedDatabaseServiceWaiter {
    private client;
    private readonly config?;
    constructor(client: ShardedDatabaseServiceClient, config?: Partial<import("oci-common/lib/waiter").WaiterConfigurationDetails> | undefined);
    /**
     ...
     */
    forShardedDatabase(request: serviceRequests.GetShardedDatabaseRequest, ...targetStates: models.ShardedDatabase.LifecycleState[]): Promise<serviceResponses.GetShardedDatabaseResponse | null>;
    /**
