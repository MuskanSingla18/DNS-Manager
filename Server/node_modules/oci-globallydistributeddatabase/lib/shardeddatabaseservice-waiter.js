...
exports.ShardedDatabaseServiceWaiter = void 0;
const models = __importStar(require("./model"));
const oci_common_1 = require("oci-common");
class ShardedDatabaseServiceWaiter {
     ...
     */
    forShardedDatabase(request, ...targetStates) {
        return __awaiter(this, void 0, void 0, function* () {
            return oci_common_1.genericTerminalConditionWaiter(this.config, () => this.client.getShardedDatabase(request), response => targetStates.includes(response.shardedDatabase.lifecycleState), targetStates.includes(models.ShardedDatabase.LifecycleState.Deleted));
        });
    }
    /**
...
exports.ShardedDatabaseServiceWaiter = ShardedDatabaseServiceWaiter;
//# sourceMappingURL=shardeddatabaseservice-waiter.js.map