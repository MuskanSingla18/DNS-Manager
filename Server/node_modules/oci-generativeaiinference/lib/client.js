...
class GenerativeAiInferenceClient {
  ...
  *
       ...
       * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/generativeaiinference/EmbedText.ts.html |here} to see how to use EmbedText API.
       */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/generativeaiinference/GenerateText.ts.html |here} to see how to use GenerateText API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/generativeaiinference/SummarizeText.ts.html |here} to see how to use SummarizeText API.
     */
