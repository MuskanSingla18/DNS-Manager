...
export declare class CommitmentClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/osubsubscription/GetCommitment.ts.html |here} to see how to use GetCommitment API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/osubsubscription/ListCommitments.ts.html |here} to see how to use ListCommitments API.
     */
...
export declare class RatecardClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/osubsubscription/ListRateCards.ts.html |here} to see how to use ListRateCards API.
     */
...
export declare class SubscriptionClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/osubsubscription/ListSubscriptions.ts.html |here} to see how to use ListSubscriptions API.
     */
