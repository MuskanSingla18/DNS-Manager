...
export declare class BillingScheduleClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListBillingSchedules.ts.html |here} to see how to use ListBillingSchedules API.
     */
...
export declare class CommitmentClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/GetCommitment.ts.html |here} to see how to use GetCommitment API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListCommitments.ts.html |here} to see how to use ListCommitments API.
     */
...
export declare class ComputedUsageClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/GetComputedUsage.ts.html |here} to see how to use GetComputedUsage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListAggregatedComputedUsages.ts.html |here} to see how to use ListAggregatedComputedUsages API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListComputedUsages.ts.html |here} to see how to use ListComputedUsages API.
     */
...
export declare class InvoiceSummaryClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListInvoicelineComputedUsages.ts.html |here} to see how to use ListInvoicelineComputedUsages API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListInvoices.ts.html |here} to see how to use ListInvoices API.
     */
...
export declare class OrganizationSubscriptionClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListOrganizationSubscriptions.ts.html |here} to see how to use ListOrganizationSubscriptions API.
     */
...
export declare class RatecardClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListRateCards.ts.html |here} to see how to use ListRateCards API.
     */
...
export declare class SubscribedServiceClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/GetSubscribedService.ts.html |here} to see how to use GetSubscribedService API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListSubscribedServices.ts.html |here} to see how to use ListSubscribedServices API.
     */
...
export declare class SubscriptionClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/onesubscription/ListSubscriptions.ts.html |here} to see how to use ListSubscriptions API.
     */
