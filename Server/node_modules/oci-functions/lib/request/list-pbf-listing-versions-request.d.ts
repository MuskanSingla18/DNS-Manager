...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/functions/ListPbfListingVersions.ts.html |here} to see how to use ListPbfListingVersionsRequest.
 */
