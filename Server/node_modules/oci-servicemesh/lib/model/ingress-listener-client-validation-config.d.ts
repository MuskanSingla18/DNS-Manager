...
export declare namespace IngressListenerClientValidationConfig {
    function getJsonObj(obj: IngressListenerClientValidationConfig): object;
    function getDeserializedJsonObj(obj: IngressListenerClientValidationConfig): object;
}
