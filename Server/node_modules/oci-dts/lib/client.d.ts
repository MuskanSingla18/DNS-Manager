...
export declare class ApplianceExportJobClient {
     ...
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ChangeApplianceExportJobCompartment.ts.html |here} to see how to use ChangeApplianceExportJobCompartment API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateApplianceExportJob.ts.html |here} to see how to use CreateApplianceExportJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DeleteApplianceExportJob.ts.html |here} to see how to use DeleteApplianceExportJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetApplianceExportJob.ts.html |here} to see how to use GetApplianceExportJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListApplianceExportJobs.ts.html |here} to see how to use ListApplianceExportJobs API.
     */
     ...
     */
    listAllApplianceExportJobs(request: requests.ListApplianceExportJobsRequest): AsyncIterableIterator<model.ApplianceExportJobSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listApplianceExportJobsRecordIterator(request: requests.ListApplianceExportJobsRequest): AsyncIterableIterator<model.ApplianceExportJobSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listApplianceExportJobs operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listApplianceExportJobsResponseIterator(request: requests.ListApplianceExportJobsRequest): AsyncIterableIterator<responses.ListApplianceExportJobsResponse>;
    /**
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/UpdateApplianceExportJob.ts.html |here} to see how to use UpdateApplianceExportJob API.
     */
...
export declare class ShippingVendorsClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListShippingVendors.ts.html |here} to see how to use ListShippingVendors API.
     */
...
export declare class TransferApplianceClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferAppliance.ts.html |here} to see how to use CreateTransferAppliance API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferApplianceAdminCredentials.ts.html |here} to see how to use CreateTransferApplianceAdminCredentials API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DeleteTransferAppliance.ts.html |here} to see how to use DeleteTransferAppliance API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferAppliance.ts.html |here} to see how to use GetTransferAppliance API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferApplianceCertificateAuthorityCertificate.ts.html |here} to see how to use GetTransferApplianceCertificateAuthorityCertificate API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferApplianceEncryptionPassphrase.ts.html |here} to see how to use GetTransferApplianceEncryptionPassphrase API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListTransferAppliances.ts.html |here} to see how to use ListTransferAppliances API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/UpdateTransferAppliance.ts.html |here} to see how to use UpdateTransferAppliance API.
     */
...
export declare class TransferApplianceEntitlementClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferApplianceEntitlement.ts.html |here} to see how to use CreateTransferApplianceEntitlement API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferApplianceEntitlement.ts.html |here} to see how to use GetTransferApplianceEntitlement API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListTransferApplianceEntitlement.ts.html |here} to see how to use ListTransferApplianceEntitlement API.
     */
...
export declare class TransferDeviceClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferDevice.ts.html |here} to see how to use CreateTransferDevice API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DeleteTransferDevice.ts.html |here} to see how to use DeleteTransferDevice API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferDevice.ts.html |here} to see how to use GetTransferDevice API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListTransferDevices.ts.html |here} to see how to use ListTransferDevices API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/UpdateTransferDevice.ts.html |here} to see how to use UpdateTransferDevice API.
     */
...
export declare class TransferJobClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ChangeTransferJobCompartment.ts.html |here} to see how to use ChangeTransferJobCompartment API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferJob.ts.html |here} to see how to use CreateTransferJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DeleteTransferJob.ts.html |here} to see how to use DeleteTransferJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferJob.ts.html |here} to see how to use GetTransferJob API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListTransferJobs.ts.html |here} to see how to use ListTransferJobs API.
     */
     ...
     * @param request a request which can be sent to the service operation
     */
    listAllTransferJobs(request: requests.ListTransferJobsRequest): AsyncIterableIterator<model.TransferJobSummary>;
    /**
     ...
     * @param request a request which can be sent to the service operation
     */
    listTransferJobsRecordIterator(request: requests.ListTransferJobsRequest): AsyncIterableIterator<model.TransferJobSummary>;
    /**
     * Creates a new async iterator which will iterate over the responses received from the listTransferJobs operation. This iterator
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     */
    listTransferJobsResponseIterator(request: requests.ListTransferJobsRequest): AsyncIterableIterator<responses.ListTransferJobsResponse>;
    /**
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/UpdateTransferJob.ts.html |here} to see how to use UpdateTransferJob API.
     */
...
export declare class TransferPackageClient {
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/AttachDevicesToTransferPackage.ts.html |here} to see how to use AttachDevicesToTransferPackage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/CreateTransferPackage.ts.html |here} to see how to use CreateTransferPackage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DeleteTransferPackage.ts.html |here} to see how to use DeleteTransferPackage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/DetachDevicesFromTransferPackage.ts.html |here} to see how to use DetachDevicesFromTransferPackage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/GetTransferPackage.ts.html |here} to see how to use GetTransferPackage API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/ListTransferPackages.ts.html |here} to see how to use ListTransferPackages API.
     */
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/dts/UpdateTransferPackage.ts.html |here} to see how to use UpdateTransferPackage API.
     */
