...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.83.0/cloudbridge/ListAssetSourceConnections.ts.html |here} to see how to use ListAssetSourceConnectionsRequest.
 */
