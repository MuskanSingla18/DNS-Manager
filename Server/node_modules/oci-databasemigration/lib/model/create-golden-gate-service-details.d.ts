...
export declare namespace CreateGoldenGateServiceDetails {
    function getJsonObj(obj: CreateGoldenGateServiceDetails): object;
    function getDeserializedJsonObj(obj: CreateGoldenGateServiceDetails): object;
}
