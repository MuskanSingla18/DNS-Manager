...
export declare namespace DumpTransferDetails {
    function getJsonObj(obj: DumpTransferDetails): object;
    function getDeserializedJsonObj(obj: DumpTransferDetails): object;
}
