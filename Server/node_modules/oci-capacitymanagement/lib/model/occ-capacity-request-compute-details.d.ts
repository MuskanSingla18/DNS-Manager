...
export declare namespace OccCapacityRequestComputeDetails {
    function getJsonObj(obj: OccCapacityRequestComputeDetails, isParentJsonObj?: boolean): object;
    const resourceType = "SERVER_HW";
    function getDeserializedJsonObj(obj: OccCapacityRequestComputeDetails, isParentJsonObj?: boolean): object;
}
